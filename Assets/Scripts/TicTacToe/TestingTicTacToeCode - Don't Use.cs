        ...
        for (int i = 0; i < 3; i++)
        {
            for (int j = 0; j < 3; j++)
            {
                if (aBoard[i][j].GetComponent<IfIveBeenClicked>().type == 0)
                {
                    if (i != 1 && j != 1)
                    {
                        List<int> anotherAnotherTmpList = new List<int>();

                        anotherAnotherTmpList.Add(i);
                        anotherAnotherTmpList.Add(j);

                        for (int k = 0; k < 7; k++)
                        {
                            if (rP[k].Equals(anotherAnotherTmpList))
                            {
                                indexThing = k;
                            }
                        }

                        foreach (int num in anotherAnotherTmpList) { Debug.Log("Coordinates of tmplist : " + num); }


                        if (indexThing == 0)
                        {
                            anotherBoard[rP[7][0]][rP[7][1]].GetComponent<IfIveBeenClicked>().type = 1;
                        }
                        else
                        {
                            anotherBoard[rP[indexThing - 1][0]][rP[indexThing - 1][1]].GetComponent<IfIveBeenClicked>().type = 1;
                        }

                    }
                    else
                    {
                        anotherBoard[1][1].GetComponent<IfIveBeenClicked>().type = 1;
                    }
            ...
            for (int j = 0; j < 3; j++)
            {
                if (aBoard[i][j].GetComponent<IfIveBeenClicked>().type == 0)
                {
                    if (i != 1 && j != 1)
                    {
                        ...
                        if (indexThing == 0)
                        {
                            anotherBoard[rP[7][0]][rP[7][1]].GetComponent<IfIveBeenClicked>().type = 2;
                        }
                        else
                        {
                            anotherBoard[rP[indexThing - 1][0]][rP[indexThing - 1][1]].GetComponent<IfIveBeenClicked>().type = 2;
                        }

                    }
                    else
                    {
                        anotherBoard[1][1].GetComponent<IfIveBeenClicked>().type = 2;
                    }
